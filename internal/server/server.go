...
func (s *Server) installHandler() {
	...
	mux.HandleFunc("DELETE /v1/workspaces/{id}/sessions/{sid}/messages/{mid}", c.handleDeleteWorkspaceSessionMessagesAfter)
	mux.HandleFunc("POST /v1/workspaces/{id}/sessions/messages/restore", c.handleRestoreWorkspaceSessionMessages)
